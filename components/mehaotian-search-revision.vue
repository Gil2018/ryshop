<template>
	<view class="serach">
		<view class="content" :style="{'border-radius':radius+'upx'}">
			<!-- HM修改 增加进入输入状态的点击范围 -->
			<view class="content-box" :class="{'center':mode === 2}" @click="getFocus">
				...
				<text v-if="isDelShow" class="iconfont icon-clear"  @click.stop="clear"></text>
			</view>
		</view>
		<view class="cannle" @click="goBack" v-if="hasCannle">
			<text>取消</text>
		</view>
